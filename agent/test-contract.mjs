...
group('пачку режет одно правило, и его читают оба драйвера');
{
  ...
  check('а после ожидания, активации, открытия, наведения, прокрутки к цели и перетаскивания - ничего',
    /'wait', 'activate_window', 'hover', 'open_url', 'open_app', 'scroll_to', 'drag',/.test(brain));
